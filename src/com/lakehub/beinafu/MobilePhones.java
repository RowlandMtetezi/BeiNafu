...
public class MobilePhones extends Activity {
	...
	public void onResume() {
		...
		ArrayList<HashMap<String, String>> mobilePhoneItems = new ArrayList<HashMap<String, String>>();
        ...
        for (Items it : items) {
			...
			mobilePhoneItems.add(map);
        }
        
    	list = (ListView) findViewById(R.id.MobilePhonesView);
		adapter = new LazyAdapter(this, mobilePhoneItems,"mobilePhones");        
